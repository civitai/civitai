...
-- AlterTable: Add accountType to BidRecurring (column already added, just update constraint)
ALTER TABLE "BidRecurring" ADD COLUMN     "accountType" TEXT NOT NULL DEFAULT 'yellow';
