...
-- DropForeignKey
ALTER TABLE "CommentV2" DROP CONSTRAINT "CommentV2_parentId_fkey";

-- DropForeignKey
ALTER TABLE "ImageComment" DROP CONSTRAINT "ImageComment_commentId_fkey";

-- DropForeignKey
ALTER TABLE "ImageComment" DROP CONSTRAINT "ImageComment_imageId_fkey";

-- DropForeignKey
ALTER TABLE "QuestionComment" DROP CONSTRAINT "QuestionComment_commentId_fkey";

-- DropForeignKey
ALTER TABLE "QuestionComment" DROP CONSTRAINT "QuestionComment_questionId_fkey";

-- AlterTable
ALTER TABLE "CommentV2" DROP COLUMN "locked",
