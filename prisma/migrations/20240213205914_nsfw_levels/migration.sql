...
ALTER TABLE "Bounty" ADD COLUMN IF NOT EXISTS     "userNsfwLevel" INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE "ModelVersion" ADD COLUMN IF NOT EXISTS     "userNsfwLevel" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "Model" ADD COLUMN IF NOT EXISTS     "nsfwLevel" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Model" ADD COLUMN IF NOT EXISTS     "userNsfwLevel" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "Post" ADD COLUMN IF NOT EXISTS     "nsfwLevel" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Post" ADD COLUMN IF NOT EXISTS     "userNsfwLevel" INTEGER NOT NULL DEFAULT 0;
