...
/**
 * The ceiling a fee may be stored at — the same number for every creator. Membership no longer narrows
 * it: what a tier governs now is how many new prices a creator may set in a month, not how large they
 * may be. See monthlyPricingAllowance.
 */
