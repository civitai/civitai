...
the server applies on save. An extension cannot widen it. Today that means tables become nested
lists and off-site images become links — see the converter for the full list.
