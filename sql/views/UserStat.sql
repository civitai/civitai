 WITH user_model_metrics_timeframe AS (
         ...
         SELECT user_model_metrics_timeframe."userId",
            ...
            max(iif((user_model_metrics_timeframe.timeframe = 'Day'::"MetricTimeframe"), user_model_metrics_timeframe."generationCount", NULL::bigint)) AS "generationCountDay",
            max(iif((user_model_metrics_timeframe.timeframe = 'Week'::"MetricTimeframe"), user_model_metrics_timeframe."generationCount", NULL::bigint)) AS "generationCountWeek",
            max(iif((user_model_metrics_timeframe.timeframe = 'Month'::"MetricTimeframe"), user_model_metrics_timeframe."generationCount", NULL::bigint)) AS "generationCountMonth",
            max(iif((user_model_metrics_timeframe.timeframe = 'Year'::"MetricTimeframe"), user_model_metrics_timeframe."generationCount", NULL::bigint)) AS "generationCountYear",
            max(iif((user_model_metrics_timeframe.timeframe = 'AllTime'::"MetricTimeframe"), user_model_metrics_timeframe."generationCount", NULL::bigint)) AS "generationCountAllTime",
