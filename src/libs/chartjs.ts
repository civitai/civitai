...
/**
 * Taken from https://www.chartjs.org/docs/latest/samples/tooltip/html.html
 */
...
export const externalTooltipHandler = (context: { chart: Chart; tooltip: TooltipModel<'bar'> }) => {
  // Tooltip Element
