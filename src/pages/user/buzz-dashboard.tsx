      ...
      <Container size="lg">
        <Stack gap="xl">
          ...
          {features.creatorComp && (
            ...
            >
              <p>
                We&rsquo;ve received reports of some creator compensation being incorrect and are
                actively reviewing. We expect things to be resolved before the next compensation
                period.
              </p>
            </DismissibleAlert>
          )}
