      ...
      <Container size="lg">
        <Stack spacing={0} mb="xl">
          ...
          <Text size="sm" color="dimmed">
            You can view and manage all available cosmetics here. You can also create new cosmetics.
            These can then be added as products in the store.
          </Text>
          <Text size="sm" color="dimmed">
            You can also add this cosmetic to user if needed. (Coming Soon)
          </Text>
        </Stack>
