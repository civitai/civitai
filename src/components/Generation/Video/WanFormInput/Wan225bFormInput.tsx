  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <InputSegmentedControl name="resolution" data={[...wan225bResolutions]} />
      </div>
