const colors = {
  blue: {
    main: '#0080FF',
    gradient: ['#0080FF', '#07006A'],
  },
  green: {
    main: '#4EB853',
    gradient: ['#00AA31', '#043F00'],
  },
  red: {
    main: '#FF0000',
    gradient: ['#BD1F26', '#450000'],
  },
  yellow: {
    main: '#FFD555',
    gradient: ['#FFD555', '#BF6500'],
  },
} as const;
  ...
  return (
    ...
    >
      <g transform="matrix(.12692 0 0 .12692 -43.144 -42.232)">
        ...
        >
          <stop offset={0.014} style={{ stopColor: gradient[0] }} />
          <stop offset={1} style={{ stopColor: gradient[1] }} />
        </linearGradient>
        <path
