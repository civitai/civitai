  ...
  return (
    ...
    >
      <Text color="red" className="font-bold">
        We could not verify this image was generated by an AI.
      </Text> 
      <Text size="sm">
        We could find no evidence that this image was generated by an AI.{' '}
        You may fix this error manually by adding relevant metadata to the image such as prompt,{' '}resources and tools used to create it.
        </Text>
    </Alert>
            )}
            {/* #endregion */}
