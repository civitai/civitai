import { getSize, MantineSize, MantineTheme, useMantineTheme } from '@mantine/core';
...
const getGutterSize = (gutter: MantineNumberSize) =>
  typeof gutter !== 'undefined' ? Number(getSize(gutter)) / 2 : undefined;
...
export default useContainerColStyles;
