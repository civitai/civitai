import { Alert, Button, Card, Grid, Group, Input, Paper, Stack, Title, Text, TextInput, Popover } from '@mantine/core';
      ...
      >
        <Stack>
          ...
          <Grid>
            ...
            <Text size="xs" lh={1.3}>
              This is the email address associated with your account. You cannot edit it here.
            </Text>
