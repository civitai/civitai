...
export type ModelShowcaseCollectionModalProps = {
...
export default function ModelShowcaseCollectionModal({
  ...
  onSelect,
  onClose,
}: ModelShowcaseCollectionModalProps) {
  ...
  return (
    <Modal {...dialog} onClose={handleClose} size={1200} withCloseButton={false} padding={0}>
      <div className="flex size-full max-h-full max-w-full flex-col overflow-hidden">
        <ResourceSelectContext.Provider value={{ onSelect: handleSelect }}>
          <InstantSearch
          ...
          >
            ...
            <div className="flex flex-col gap-3 p-3">
              <div className="flex items-center justify-between">
                <Text>Select Model Collection Showcase</Text>
