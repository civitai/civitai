...
type UniversalPlayerState = {
  currentTrack: Partial<Track> | null;
  setCurrentTrack: React.Dispatch<React.SetStateAction<Partial<Track> | null>>;
...
export const useAudioPlayerContext = () => useContext(UniversalPlayerContext);
