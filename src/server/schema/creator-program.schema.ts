...
import { preprocessAccountType, bankableBuzzTypes } from '~/server/schema/buzz.schema';
import {
  MIN_BANK_AMOUNT,
...
export const bankBuzzSchema = z.object({
  ...
  accountType: z.preprocess(preprocessAccountType, z.enum(bankableBuzzTypes).default('yellow')),
});
