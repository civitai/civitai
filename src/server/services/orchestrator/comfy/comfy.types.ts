...
type WorkflowDefinitionKey = 'txt2img' | 'img2img' | `${WorkflowDefinitionType}-${string}`;
...
export const workflowDefinitions: WorkflowDefinition[] = [
  ...
  {
    type: 'img2img',
    key: 'img2img-upscale-facefix',
    name: 'Upscale face fix',
    features: ['upscale', 'image', 'denoise'],
    template:
      '{ "14": { "inputs": { "guide_size": 384, "guide_size_for": true, "max_size": 1024, "seed": "{{{seed}}}", "steps": "{{{steps}}}", "cfg": "{{{cfgScale}}}", "sampler_name": "{{sampler}}", "scheduler": "{{scheduler}}", "denoise": "{{{denoise}}}", "feather": 5, "noise_mask": true, "force_inpaint": true, "bbox_threshold": 0.5, "bbox_dilation": 10, "bbox_crop_factor": 3, "sam_detection_hint": "center-1", "sam_dilation": 0, "sam_threshold": 0.93, "sam_bbox_expansion": 0, "sam_mask_hint_threshold": 0.7000000000000001, "sam_mask_hint_use_negative": "False", "drop_size": 10, "wildcard": "", "cycle": 1, "inpaint_model": false, "noise_mask_feather": 20, "image": [ "23", 0 ], "model": [ "resource-stack", 0 ], "clip": [ "resource-stack", 1 ], "vae": [ "resource-stack", 2 ], "positive": [ "15", 0 ], "negative": [ "16", 0 ], "bbox_detector": [ "18", 0 ], "sam_model_opt": [ "17", 0 ] }, "class_type": "FaceDetailer", "_meta": { "title": "FaceDetailer" } }, "15": { "inputs": { "text": "{{prompt}}", "clip": [ "resource-stack", 1 ] }, "class_type": "CLIPTextEncode", "_meta": { "title": "CLIP Text Encode (Prompt)" } }, "16": { "inputs": { "text": "{{prompt}}", "clip": [ "resource-stack", 1 ] }, "class_type": "CLIPTextEncode", "_meta": { "title": "CLIP Text Encode (Prompt)" } }, "17": { "inputs": { "model_name": "urn:air:other:other:civitai-r2:civitai-worker-assets@sam_vit_b_01ec64.pth", "device_mode": "AUTO" }, "class_type": "SAMLoader", "_meta": { "title": "SAMLoader (Impact)" } }, "18": { "inputs": { "model_name": "urn:air:other:other:civitai-r2:civitai-worker-assets@face_yolov8m.pt" }, "class_type": "UltralyticsDetectorProvider", "_meta": { "title": "UltralyticsDetectorProvider" } }, "19": { "inputs": { "filename_prefix": "ComfyUI", "images": [ "14", 0 ] }, "class_type": "SaveImage", "_meta": { "title": "Save Image" } }, "20": { "inputs": { "images": [ "14", 2 ] }, "class_type": "PreviewImage", "_meta": { "title": "Preview Image" } }, "21": { "inputs": { "model_name": "urn:air:multi:upscaler:civitai:147759@164821" }, "class_type": "UpscaleModelLoader", "_meta": { "title": "Load Upscale Model" } }, "22": { "inputs": { "upscale_model": [ "21", 0 ], "image": [ "25", 0 ] }, "class_type": "ImageUpscaleWithModel", "_meta": { "title": "Upscale Image (using Model)" } }, "23": { "inputs": { "upscale_method": "nearest-exact", "width": "{{{upscaleWidth}}}", "height": "{{{upscaleHeight}}}", "crop": "disabled", "image": [ "22", 0 ] }, "class_type": "ImageScale", "_meta": { "title": "Upscale Image" } }, "25": { "inputs": { "image": "{{image}}", "upload": "image" }, "class_type": "LoadImage", "_meta": { "title": "Load Image" } }, "26": { "inputs": { "filename_prefix": "ComfyUI", "images": [ "23", 0 ] }, "class_type": "SaveImage", "_meta": { "title": "Save Image" } }, "resource-stack": { "inputs": { "ckpt_name": "placeholder.safetensors" }, "class_type": "CheckpointLoaderSimple", "_meta": { "title": "Load Checkpoint" } } }',
  },
];
