...
export const createHappyHorseInput = defineHandler<
  EcosystemData<'HappyHorse'>,
  [VideoGenStepTemplate]
>((data) => {
    ...
    return [
      {
        ...
        input: removeEmpty({
          ...
          operation: 'referenceToVideo',
          images,
          aspectRatio: data.aspectRatio?.value as HappyHorseV1ReferenceToVideoInput['aspectRatio'],
