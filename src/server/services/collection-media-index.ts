...
// search index, called around writes that have either already committed or are about
// to; a failure must cost a stale document, never the user's write. Failures are
