...
function mapBitdexDoc(doc: Record<string, unknown>) {
  ...
  return {
    ...
    tagIds: Array.isArray(doc.tagIds) ? doc.tagIds as number[] : doc.tagIds ? [doc.tagIds as number] : [],
    modelVersionIds: Array.isArray(doc.modelVersionIds) ? doc.modelVersionIds as number[] : doc.modelVersionIds ? [doc.modelVersionIds as number] : [],
    toolIds: Array.isArray(doc.toolIds) ? doc.toolIds as number[] : doc.toolIds ? [doc.toolIds as number] : [],
    techniqueIds: Array.isArray(doc.techniqueIds) ? doc.techniqueIds as number[] : doc.techniqueIds ? [doc.techniqueIds as number] : [],
