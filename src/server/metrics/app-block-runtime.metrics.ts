 ...
 *     SEPARATES THE TWO CAUSES — only whether a submit produced a workflow at all
 *     does, and no series here carries that. `quoted` is its success half and
