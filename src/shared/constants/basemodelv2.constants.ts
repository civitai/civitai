...
export type BaseModelRecord = {
  ...
  licenseId?: number;
  // NOTE: canGenerate/canTrain/canAuction removed - derived from EcosystemSupport
  // NOTE: engine removed - defined in EcosystemSettings.defaults.engine
  // NOTE: deprecated removed - use disabled: true instead
};
...
export const ecosystems: EcosystemRecord[] = [
  ...
  { id: ECO.Flux1, key: 'Flux1', name: 'flux1', displayName: 'Flux.1', familyId: 1, sortOrder: 0 },
  {
    id: ECO.FluxKrea,
    key: 'FluxKrea',
    name: 'fluxkrea',
  ...
  { id: ECO.Flux2, key: 'Flux2', name: 'flux2', displayName: 'Flux.2', familyId: 1, sortOrder: 3 },
  ...
  { id: ECO.Veo3, key: 'Veo3', name: 'veo3', displayName: 'Veo 3', familyId: 7, sortOrder: 72 },
  ...
  { id: ECO.Sora2, key: 'Sora2', name: 'sora2', displayName: 'Sora 2', familyId: 8, sortOrder: 81 },
  ...
  { id: ECO.HiDream, key: 'HiDream', name: 'hidream', displayName: 'HiDream', sortOrder: 203 },
  ...
  { id: ECO.Mochi, key: 'Mochi', name: 'mochi', displayName: 'Mochi', sortOrder: 207 },
  ...
  { id: ECO.Other, key: 'Other', name: 'other', displayName: 'Other', sortOrder: 999 },
];
...
// =============================================================================
// Base Model Families (unchanged from v1)
// =============================================================================
...
export const baseModels: BaseModelRecord[] = [
  // AuraFlow
  { id: BM.AuraFlow, name: 'AuraFlow', type: 'image', ecosystemId: ECO.AuraFlow, licenseId: 13 },

  // Chroma
  { id: BM.Chroma, name: 'Chroma', type: 'image', ecosystemId: ECO.Chroma, licenseId: 13 },

  // CogVideoX
  { id: BM.CogVideoX, name: 'CogVideoX', type: 'image', ecosystemId: ECO.CogVideoX, licenseId: 17 },

  // Flux.1
  { id: BM.Flux1S, name: 'Flux.1 S', type: 'image', ecosystemId: ECO.Flux1, licenseId: 13 },
  { id: BM.Flux1D, name: 'Flux.1 D', type: 'image', ecosystemId: ECO.Flux1, licenseId: 14 },
  {
    id: BM.Flux1Krea,
    name: 'Flux.1 Krea',
    type: 'image',
  ...
  { id: BM.Flux2D, name: 'Flux.2 D', type: 'image', ecosystemId: ECO.Flux2, licenseId: 14 },

  // HiDream
  { id: BM.HiDream, name: 'HiDream', type: 'image', ecosystemId: ECO.HiDream, licenseId: 19 },

  // Hunyuan
  { id: BM.Hunyuan1, name: 'Hunyuan 1', type: 'image', ecosystemId: ECO.HyDit1, licenseId: 10 },
  {
    id: BM.HunyuanVideo,
    name: 'Hunyuan Video',
    type: 'video',
  ...
  // Kolors
  { id: BM.Kolors, name: 'Kolors', type: 'image', ecosystemId: ECO.Kolors, licenseId: 12 },

  // LTXV
  { id: BM.LTXV, name: 'LTXV', type: 'video', ecosystemId: ECO.LTXV, licenseId: 16 },

  // Lumina
  { id: BM.Lumina, name: 'Lumina', type: 'image', ecosystemId: ECO.Lumina, licenseId: 13 },

  // Mochi
  { id: BM.Mochi, name: 'Mochi', type: 'image', ecosystemId: ECO.Mochi, licenseId: 13 },
  ...
  // NoobAI
  { id: BM.NoobAI, name: 'NoobAI', type: 'image', ecosystemId: ECO.NoobAI, licenseId: 18 },

  // ODOR
  { id: BM.ODOR, name: 'ODOR', type: 'image', ecosystemId: ECO.ODOR, hidden: true },
  ...
  // Other
  { id: BM.Other, name: 'Other', type: 'image', ecosystemId: ECO.Other },

  // PixArt
  { id: BM.PixArtA, name: 'PixArt a', type: 'image', ecosystemId: ECO.PixArtA, licenseId: 3 },
  { id: BM.PixArtE, name: 'PixArt E', type: 'image', ecosystemId: ECO.PixArtE, licenseId: 3 },
  ...
  // Pony
  { id: BM.Pony, name: 'Pony', type: 'image', ecosystemId: ECO.Pony, licenseId: 3 },
  { id: BM.PonyV7, name: 'Pony V7', type: 'image', ecosystemId: ECO.PonyV7, licenseId: 24 },

  // Qwen
  { id: BM.Qwen, name: 'Qwen', type: 'image', ecosystemId: ECO.Qwen, licenseId: 13 },
  ...
  // SD 1.x
  { id: BM.SD14, name: 'SD 1.4', type: 'image', ecosystemId: ECO.SD1, licenseId: 1 },
  { id: BM.SD15, name: 'SD 1.5', type: 'image', ecosystemId: ECO.SD1, licenseId: 1 },
  { id: BM.SD15LCM, name: 'SD 1.5 LCM', type: 'image', ecosystemId: ECO.SD1, licenseId: 3 },
  { id: BM.SD15Hyper, name: 'SD 1.5 Hyper', type: 'image', ecosystemId: ECO.SD1, licenseId: 3 },

  // SD 2.x
  { id: BM.SD20, name: 'SD 2.0', type: 'image', ecosystemId: ECO.SD2, licenseId: 1 },
  {
    id: BM.SD20_768,
    name: 'SD 2.0 768',
    type: 'image',
  ...
  { id: BM.SD21, name: 'SD 2.1', type: 'image', ecosystemId: ECO.SD2, licenseId: 1 },
  {
    id: BM.SD21_768,
    name: 'SD 2.1 768',
    type: 'image',
  ...
  { id: BM.SDXL10, name: 'SDXL 1.0', type: 'image', ecosystemId: ECO.SDXL, licenseId: 3 },
  {
    id: BM.SDXL10LCM,
    name: 'SDXL 1.0 LCM',
    type: 'image',
  ...
  { id: BM.SDXLHyper, name: 'SDXL Hyper', type: 'image', ecosystemId: ECO.SDXL, licenseId: 3 },
  {
    id: BM.SDXLTurbo,
    name: 'SDXL Turbo',
    type: 'image',
  ...
  // Veo 3
  { id: BM.Veo3, name: 'Veo 3', type: 'video', ecosystemId: ECO.Veo3, hidden: true, licenseId: 22 },
...
export function getEcosystemFamily(ecosystemId: number): BaseModelFamilyRecord | undefined {
  ...
  return familyById.get(ecosystem.familyId);
}
...
export function getCompatibleBaseModels(
  ...
  for (const model of baseModels) {
    if (model.hidden || model.disabled) continue;
