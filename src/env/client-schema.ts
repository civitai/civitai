...
export const clientSchema = z.object({
  ...
  NEXT_PUBLIC_PLAYWIRE_PUBLISHER_ID: z.string().optional(),
  NEXT_PUBLIC_PLAYWIRE_WEBSITE_ID: z.string().optional(),
});
...
export const clientEnv = {
  ...
  NEXT_PUBLIC_PLAYWIRE_PUBLISHER_ID: process.env.NEXT_PUBLIC_PLAYWIRE_PUBLISHER_ID,
  NEXT_PUBLIC_PLAYWIRE_WEBSITE_ID: process.env.NEXT_PUBLIC_PLAYWIRE_WEBSITE_ID,
};
